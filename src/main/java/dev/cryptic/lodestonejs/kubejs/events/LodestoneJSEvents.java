...
public class LodestoneJSEvents {
    ...
    public static final EventGroup WORLD_EVENTS_GROUP = EventGroup.of("LodestoneWorldEvents");
    ...
    public static final EventHandler WORLD_EVENT_SPAWN = WORLD_EVENTS_GROUP.server("spawn", () -> WorldEventCreationEventJS.class).extra(SUPPORTS_WORLD_EVENT_TYPE);
    public static final EventHandler WORLD_EVENT_DISCARD = WORLD_EVENTS_GROUP.server("discard", () -> WorldEventDiscardEventJS.class).extra(SUPPORTS_WORLD_EVENT_TYPE);
    public static final EventHandler WORLD_EVENT_TICK = WORLD_EVENTS_GROUP.server("tick", () -> WorldEventTickEventJS.class).extra(SUPPORTS_WORLD_EVENT_TYPE);
    public static final EventHandler WORLD_EVENT_RENDER = WORLD_EVENTS_GROUP.client("render", () -> WorldEventRenderEventJS.class).extra(SUPPORTS_WORLD_EVENT_TYPE);
